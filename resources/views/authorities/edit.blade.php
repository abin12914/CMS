                ...
                <div class="col-md-8">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username text-capitalize">&emsp;Edit Authority</h3>
                            <div class="widget-user-desc">&nbsp;&nbsp;&nbsp;&emsp; Fields marked with <i class="text-red">* </i> are mandatory.
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="{{route('authority.update', $authority->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="name" class="form-control" id="name" placeholder="Authority name" value="{{ old('name', $authority->name) }}" tabindex="1" maxlength="100">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="designation" class="form-control alpha_only" id="designation" placeholder="Designation name" value="{{ old('designation', $authority->designation) }}" tabindex="2" maxlength="100">
                                                {{-- adding error_message p tag component --}}
