                    ...
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header">
                            <div class="widget-user-image">
                                <img class="img-circle" src="/images/public/default_authority.png" alt="User Avatar">
                            </div>
                            <!-- /.widget-user-image -->
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="name" class="form-control" id="name" placeholder="Authority name" value="{{ old('name') }}" tabindex="2" maxlength="100">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="designation" class="form-control alpha_only" id="designation" placeholder="Authority descriptive name" value="{{ old('designation') }}" tabindex="2" maxlength="100">
                                                {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            <label for="authority" class="col-md-3 control-label">Authority : </label>
                                            <div class="col-md-9">
                                                <input type="text" name="authority" class="form-control" id="authority" placeholder="University" value="{{ old('authority') }}" tabindex="4" minlength="10" maxlength="13">
                                                {{-- adding error_message p tag component --}}
                                                @component('components.paragraph.error_message', ['fieldName' => 'authority'])
                                                @endcomponent
                                            </div>
                                        </div>
                                        <div class="form-group">
