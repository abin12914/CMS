@extends('layouts.app')
@section('title', 'University Registration')
@section('content')
                ...
                <div class="col-md-8">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username text-capitalize">&emsp;University Registration</h3>
                            <div class="widget-user-desc">&nbsp;&nbsp;&nbsp;&emsp; Fields marked with <i class="text-red">* </i> are mandatory.
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="{{route('university.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="university_name" class="form-control" id placeholder="University name" value="{{ old('university_name') }}" tabindex="1" maxlength="100">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="center_code" class="form-control" id="center_code" placeholder="Center Code" value="{{ old('center_code') }}" tabindex="2" maxlength="100">
                                                {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="university_grade" class="form-control" id="university_grade" placeholder="University Grade" value="{{ old('university_grade') }}" tabindex="3" maxlength="100">
                                                {{-- adding error_message p tag component --}}
