                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="batch_name" class="form-control" id="batch_name" placeholder="Batch name" value="{{ old('batch_name') }}" tabindex="1" maxlength="100">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                @component('components.selects.courses', ['selectedCourseId' => old('course_id'), 'selectName' => 'course_id', 'activeFlag' => false, 'tabindex' => 2])
                                                @endcomponent
                                                {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="fee_amount" class="form-control" id="fee_amount" placeholder="Fee amount" value="{{ old('fee_amount') }}" tabindex="5" maxlength="100">
                                                {{-- adding error_message p tag component --}}
