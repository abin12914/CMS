                        ...
                        <form action="{{route('batch.update', $batch->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="fee_per_year" class="form-control" id="fee_per_year" placeholder="Fee per year" value="{{ old('fee_per_year', $batch->fee_per_year) }}" tabindex="6" maxlength="100">
                                                {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="fee_per_sem" class="form-control" id="fee_per_sem" placeholder="Fee per semester" value="{{ old('fee_per_sem', $batch->fee_per_sem) }}" tabindex="7" maxlength="100">
                                                {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="fee_per_month" class="form-control" id="fee_per_month" placeholder="Fee per month" value="{{ old('fee_per_month', $batch->fee_per_month) }}" tabindex="8" maxlength="100">
                                                {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="class_start_date" class="form-control datepicker_edit" id="class_start_date" placeholder="Starting date of this acadamic year" value="{{ old('class_start_date', $batch->class_start_date->format('d-m-Y')) }}" tabindex="9" maxlength="100">
                                                {{-- adding error_message p tag component --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <button type="button" class="btn btn-warning btn-block btn-flat update_button" tabindex="10">Submit</button>
                                    </div>
                                    <!-- /.col -->
                                </div><br>
                            </div>
