                ...
                <div class="col-md-8">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username text-capitalize">&emsp;Student Edit</h3>
                            <div class="widget-user-desc">&nbsp;&nbsp;&nbsp;&emsp; Fields marked with <i class="text-red">* </i> are mandatory.
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="{{route('student.update', $student->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="student_code" class="form-control" id="student_code" placeholder="Student unique code" value="{{ old('student_code', $student->student_code) }}" tabindex="1" maxlength="100">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="name" class="form-control alpha_only" id="name" placeholder="Student name" value="{{ old('name', $student->name) }}" tabindex="2" maxlength="100">
                                                {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                @else
                                                    <textarea class="form-control" name="address" id="address" rows="3" placeholder="Address" style="resize: none;" tabindex="3" maxlength="200">{{ $student->address }}</textarea>
                                                @endif
                                                {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="phone" class="form-control number_only" id="phone" placeholder="Phone number" value="{{ old('phone', $student->phone) }}" tabindex="4" minlength="10" maxlength="13">
                                                {{-- adding error_message p tag component --}}
                                                ...
                                                <select class="form-control select2" name="title" id="title" tabindex="5" style="width: 100%;">
                                                    ...
                                                    @if(!empty($studentTitles))
                                                        @foreach($studentTitles as $key => $studentTitle)
                                                            <option value="{{ $key }}" {{ (old('title', $student->title) == $key) ? 'selected' : '' }}>
                                                                {{ $studentTitle }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                @component('components.selects.batches', ['selectedBatchId' => old('batch_id', $student->batch_id), 'selectName' => 'batch_id', 'activeFlag' => false, 'tabindex' => 7])
                                                @endcomponent
                                                {{-- adding error_message p tag component --}}
